 ...
 * @author maula
 */
public class fmMostrar2 extends javax.swing.JFrame {

    /**
     * Creates new form fmMostrar2
     */
    public fmMostrar2() {
        initComponents();
        ...
        try{
            ...
            m1.addColumn("Numero de Aosciado");
            m1.addColumn("Cedula");
            m1.addColumn("Nombre");
            m1.addColumn("Apellido1");
            m1.addColumn("Apellido2");
            m1.addColumn("Fecha");
            m1.addColumn("Calidad");
            m1.addColumn("Nivel");
            m1.addColumn("Cuota");
            m1.addColumn("Estado");
            m1.addColumn("Retiro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmMostrar2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fmMostrar2().setVisible(true);
            }
        });
    }
