 ...
 * @author maula
 */
public class fmMostrar3 extends javax.swing.JFrame {

    /**
     * Creates new form fmMostrar3
     */
    public fmMostrar3() {
        initComponents();
        ...
        try{
            ...
            m1.addColumn("ID");
            m1.addColumn("Numero de Asociado");
            m1.addColumn("Nombre");
            m1.addColumn("Apellido1");
            m1.addColumn("Apellido2");
            m1.addColumn("Acumulado");
            m1.addColumn("Año");
            m1.addColumn("Mes");
            m1.addColumn("Fecha");
            m1.addColumn("Monto");
            m1.addColumn("Recibo");
            m1.addColumn("Numero de Certificados");
            m1.addColumn("Total");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmMostrar3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fmMostrar3().setVisible(true);
            }
        });
    }
