 ...
 * @author maula
 */
public class fmAdministrativos extends javax.swing.JInternalFrame {

    /**
     * Creates new form fmParqueo
     */
    espacio mod = new espacio();
    ConsultasAD as = new ConsultasAD();
    administrativos mod1 = new administrativos();
    cone mod2 = new cone();
    ConsultasCO re = new ConsultasCO();
    DefaultTableModel m4 = new DefaultTableModel();

    public fmAdministrativos() {
        initComponents();
        ...
        try {
            ...
            String sql = "SELECT espacio,estado FROM tb_administrativos";
    ...
    private void btnDerechaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDerechaActionPerformed
        ...
        try {
            ...
            String sql = "SELECT ced,espacio,horaE,horaS FROM tb_administrativos WHERE espacio=?";
            ps = con.prepareStatement(sql);
            ps.setInt(1, a);
            rs = ps.executeQuery();
            ...
            while (rs.next()) {
                ...
                txtHoraE.setText(rs.getString("horaE"));
    ...
    private void DatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DatosMouseClicked
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT ced,espacio,horaE,horaS FROM tb_administrativos WHERE espacio=?");
    ...
    private void btnBuscar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscar1ActionPerformed
        ...
        if (bus == "Libre") {
            ...
            try {
                ...
                String sql = "SELECT espacio,estado FROM tb_administrativos WHERE estado= 'Libre'";
            ...
            try {
                ...
                String sql = "SELECT espacio,estado FROM tb_administrativos WHERE estado= 'Ocupado'";
                System.out.println(sql);
                ps = con.prepareStatement(sql);
                rs = ps.executeQuery();
            ...
            try {
                ...
                String sql = "SELECT espacio,estado FROM tb_administrativos WHERE espacio= '" + ced + "'";
                System.out.println(sql);
                ps = con.prepareStatement(sql);
                rs = ps.executeQuery();
