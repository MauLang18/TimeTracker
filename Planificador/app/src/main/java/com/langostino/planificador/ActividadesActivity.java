...
public class ActividadesActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbPlanificador dbContactos = new DbPlanificador(ActividadesActivity.this);
    ...
    private void nuevoRegistro(){
        Intent intent = new Intent(this, NuevoAActivity.class);
